...
script AppDelegate
    ...
    property helpdoc : missing value ## Help
    ...
    property helpdocvalue : missing value ## Help Document
    ...
    on applicationWillFinishLaunching_(aNotification)
        ...
        set helpdoccheck to do shell script "defaults read /private/tmp/com.sctcoding.policyhelper.plist DocumentationURL"
        ...
        if helpdoccheck is "None" then
            tell helpdoc to setEnabled_(false)
        end if
    ...
    on customize_(sender)
        ...
        set helpdocvalue to (helpdoc's state())
        if helpdocvalue is 1 then
            do shell script "pname=$(defaults read /private/tmp/com.sctcoding.policyhelper.plist name); helper=$(defaults read /private/tmp/com.sctcoding.policyhelper.plist DocumentationURL); echo \"open -a Safari $helper\" >> /private/tmp/policyHelper_$pname.sh"
        end if
